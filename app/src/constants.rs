...
pub const GNOSIS_VPN_INPUT_JSON_PATH: &str = "./inputs/gnosis_vpn_input.json";
pub const GNOSIS_VPN_OUTPUT_ITEMS_PATH: &str = "./outputs/gnosis_vpn_items.txt";
pub const GNOSIS_VPN_OUTPUT_RESULT_PATH: &str = "./outputs/gnosis_vpn_result.txt";
pub const ZULIP_TOPIC_INPUT_PATH: &str = "./inputs/zulip_topic_messages.json";
pub const ZULIP_TOPIC_SUMMARY_PATH: &str = "./outputs/zulip_topic_summary.md";
